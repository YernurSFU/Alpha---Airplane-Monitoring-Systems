...
// command will be a hex code specifying a command defined in the
// display’s datasheet
static void sendCommand(unsigned char command)
{
    char buf[2];
...
// Data will contain the data you wish to display
static void sendData(unsigned char Data)
{
    char buf[2];
    buf[0] = DATA_MODE;
...
void Oled_setHorizontalScrollProperties(_Bool direction, unsigned char startRow, unsigned char endRow, unsigned char startColumn, unsigned char endColumn, unsigned char scrollSpeed)
{
    /*
